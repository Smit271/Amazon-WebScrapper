...
class Amazon_automation():
    def __init__(self, search_item, page_no):
        self.search_item = search_item
        self.page_no = page_no

    # Method for get data from Amazon
    def get_data(self, search_item, page_no):
    ...
    def store_in_db(self, title, price, link, rating, review):
    ...
    def get_details(self, soup):
        ...
        for item in products:
            ...
            self.store_in_db(name, price, baseurl + link, rating, review)
    ...
    def main(self):
        ...
        while i <= page_no:
            deal = self.get_details(self.get_data(search_item, i))
            print(f"Completed page number : {i}\tItem Counts : {len(deal['title'])}")
            i += 1
        print("Finished, Please check Database file")
        #print(deal) # To print Dict of data


# Creating Object of Amazon_automation class
amazon = Amazon_automation(search_item, page_no)
# Calling main method of object
amazon.main()
